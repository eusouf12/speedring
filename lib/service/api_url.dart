class ApiUrl {
  static const String baseUrl =
      "https://global-jump-backend.onrender.com/api/v1";
  ...
  static const String setupUserProfileConsultants =
      "/users/consultant-profile-complete";

  ///========================= User =========================
  // static String getRecommendedCountries ({required String page}) => "/recommendations/history?page=$page&limit=10";

  static String getRecommendedCountries({
  ...
  static String getSingleCountry({required String country}) =>
      "/countries/$country"; //eligibleVisas
  static String eligibleVisas({required String country}) =>
      "/countries/$country/eligible-visas";
  static String saveCountry({required String id}) =>
      "/recommendations/save/$id";
  static String deleteCountry({required String id}) =>
      "/recommendations/saved/$id";
  static String getConsultants({required String page}) =>
      "/users/all-consultants?page=$page&limit=10";
  static String getBookedConsultants({required String page}) =>
      "/bookings/my-bookings?page=$page&limit=10";
  static String bookedConsultant({required String id}) => "/bookings/$id";
  static String getSaveCountry({required String page}) =>
      "/recommendations/saved?page=$page&limit=10";
  static String getSingleConsultant({required String id}) =>
      "/users/consultant/$id";
  ...
  static const String earningTrend =
      "/bookings/consultant/analytics/earning-trend";
  static const String bookingTrend =
      "/bookings/consultant/analytics/booking-trend";
  static String allAppointments({required String page}) =>
      "/bookings/consultant/my-bookings?page=$page&limit=10";
  static String myBookingCalender({
    required String year,
    required String month,
  }) => "/bookings/consultant/calendar/booked-dates?year=$year&month=$month";
  static String getSingleBooking({required String id}) =>
      "/bookings/consultant/my-bookings/$id";
  static String cancelAppointment({required String id}) =>
      "/bookings/consultant/booking/respond/$id";
  static String confirmAppointment({required String id}) =>
      "/bookings/consultant/booking/respond/$id";
