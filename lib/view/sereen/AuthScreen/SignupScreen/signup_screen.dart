                    ...
                    children: [
                      ...
                      CustomTextField(
                        ...
                        validator: (v) {
                          ...
                          if (v.trim().length < 3) return 'minChar3'.tr;
                          if (v.contains(' ')) return 'noSpaces'.tr;
                          return null;
                        },
                      ),
                            ...
                            : Column(
                                children: [
                                  CustomButton(
                                    ...
                                    title: 'createAccount'.tr.toUpperCase(),
                      ...
                      Center(
                        child: Row(
                          ...
                          children: [
                            CustomText(
                              text: 'alreadyHaveAccountSignup'.tr,
                              color: Colors.white54,
                              fontSize: 14,
                            ),
                            GestureDetector(
