        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomText(
                text:
                    "Manage your active campaigns, schedule future posts, or review previous runs to optimize your reach.",
              ...
              _buildCampaignCard(
                ...
                imageUrl:
                    "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=200&fit=crop",
              ),
              SizedBox(height: 16.h),
    ...
    final navItems = [
      {
        ...
        'route': AppRoutes.businessProfileScreen,
      },
      {
        'label': 'STATS',
            ...
            return GestureDetector(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(item['icon'] as IconData, size: 22.sp, color: color),
                    SizedBox(height: 4.h),
                    Text(
