              ...
              onPressed: homeCtrl.isPostCreating.value
                  ...
                  : () async {
                      if (homeCtrl.trackCircuitCtrl.text.isEmpty) {
                        showCustomSnackBar("Circuit is required", isError: true);
                        return;
                      }
                      ...
                      final success = await homeCtrl.createPost(
                        ...
                        trackUpdateDetails: {
                          ...
                          "surfaceCondition": homeCtrl.trackSelectedCondition.value,
          ...
          children: [
            ...
            Obx(() => Row(
              ...
              children: conditions.map((condition) {
                final isSelected = homeCtrl.trackSelectedCondition.value == condition;
                ...
                return Expanded(
                  child: GestureDetector(
                    onTap: () => homeCtrl.trackSelectedCondition.value = condition,
                    child: Container(
            ...
            Obx(() => GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    homeCtrl.isPostCreating.value ? "PUBLISHING..." : "PUBLISH UPDATE",
                    style: TextStyle(
