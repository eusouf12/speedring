...
class _AddSpotScreenState extends State<AddSpotScreen> {
  ...
  final TextEditingController _zeroToHundredController = TextEditingController();
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: const [
                          Icon(Icons.add_a_photo_outlined, color: AppColors.yellow, size: 32),
                          SizedBox(height: 12),
                          Text(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: const [
                        Icon(Icons.flash_on, color: AppColors.yellow, size: 10),
                        SizedBox(width: 4),
                        Text(
                          "POWER (HP)",
                          style: TextStyle(
                    ...
                    Row(
                      children: const [
                        Icon(Icons.timer_outlined, color: AppColors.yellow, size: 10),
                        SizedBox(width: 4),
                        Text(
                          "0-100 KM/H (S)",
                          style: TextStyle(
