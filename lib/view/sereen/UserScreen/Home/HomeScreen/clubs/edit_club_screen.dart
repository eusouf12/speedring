...
class _EditClubScreenState extends State<EditClubScreen> {
  String selectedSecurity = "PRIVATE";
  ...
  List<String> tags = ["GT3", "Nürburgring", "Flat-Six", "9000-RPM"];
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    /// Security options
                    _buildSecurityOption("PUBLIC", "OPEN ENTRY"),
                    const SizedBox(height: 8),
                    _buildSecurityOption("PRIVATE", "APPROVAL REQ."),
                    const SizedBox(height: 8),
                    _buildSecurityOption("INVITE ONLY", "STEALTH MODE"),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildSecurityOption(String title, String subtitle) {
    final bool isSelected = title == selectedSecurity;
    return GestureDetector(
      onTap: () {
        setState(() {
          selectedSecurity = title;
        });
      },
      child: Container(
