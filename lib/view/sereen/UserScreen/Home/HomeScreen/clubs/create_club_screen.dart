...
class _CreateClubScreenState extends State<CreateClubScreen> {
  String selectedClass = "GT3 SERIES";
  String selectedAccess = "PUBLIC";
  bool telemetryVerification = true;
            ...
            Container(
              ...
              child: Wrap(
                ...
                children: categories.map((cat) {
                  final bool isSelected = cat['name'] == selectedClass;
                  return GestureDetector(
                    onTap: () {
                      setState(() {
                        selectedClass = cat['name'];
                      });
                    },
                    child: Container(
                ...
                children: [
                  ...
                  Row(
                    children: ["PUBLIC", "APPROVAL", "INVITE"].map((type) {
                      final bool isSel = type == selectedAccess;
                      return Expanded(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Switch(
                        value: telemetryVerification,
                        onChanged: (val) {
                          setState(() {
                            telemetryVerification = val;
                          });
                        },
