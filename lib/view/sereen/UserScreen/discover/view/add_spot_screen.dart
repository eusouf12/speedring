...
class _AddSpotScreenState extends State<AddSpotScreen> {
  ...
  /// Primary upload: picks up to 3 images at once and fills slots automatically.
  ...
  /// Secondary slot: replaces one specific slot.
                        ...
                        children: [
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: _buildSecondarySlot(_secondaryImage1),
                            ),
                          ),
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: _buildSecondarySlot(_secondaryImage2),
                            ),
                          ),
                        ],
                      ),
  ...
  Widget _buildSecondarySlot(XFile? image) {
    return Container(
      height: 80,
      decoration: BoxDecoration(
