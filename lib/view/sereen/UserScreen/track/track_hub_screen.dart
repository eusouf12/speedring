              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: const [
                        Icon(Icons.map_outlined, color: AppColors.yellow, size: 20),
                        SizedBox(width: 8),
                        Text(
                          "FIND A TRACK",
                          style: TextStyle(
                    ...
                    Row(
                      children: const [
                        ...
                        SizedBox(width: 4),
                        Icon(Icons.chevron_right, color: AppColors.yellow, size: 12),
                      ],
                    ),
                  ],
                ),
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: NetworkImage("https://images.unsplash.com/photo-1617814076367-b759c7d7e738?w=600&auto=format&fit=crop"),
                    fit: BoxFit.cover,
                    opacity: 0.35,
                  ),
                ),
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: const [
                          Icon(Icons.people_outline, color: AppColors.yellow, size: 20),
                          SizedBox(width: 8),
                          Text(
                            "GROUP DRIVES",
                            style: TextStyle(
